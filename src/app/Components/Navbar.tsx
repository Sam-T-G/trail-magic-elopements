		...
		<header className="text-slate-100 body-font bg-stone-400 h-auto">
			<div className="container mx-auto flex flex-col p-0 md:flex-row items-center justify-between">
				...
				<div className="flex flex-wrap items-center p-5">
					...
					<Link href="/projects">
						<button className="inline-flex items-center border-amber-800 border-2 bg-white text-amber-800 font-semibold py-1 px-3 focus:outline-none hover:bg-amber-800 transform transition-transform hover:scale-110 hover:text-white rounded-lg text-base">
							Contact
						</button>
					</Link>
				</div>
